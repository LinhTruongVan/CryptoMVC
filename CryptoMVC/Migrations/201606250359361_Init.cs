namespace CryptoMVC.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ExamAssignments", "ExamId", "dbo.Exams");
            DropForeignKey("dbo.Exams", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.ExamAssignments", "DocumentId", "dbo.Documents");
            DropForeignKey("dbo.ExamAssignments", "ApplicationUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.ExamAssignments", new[] { "ExamId" });
            DropIndex("dbo.ExamAssignments", new[] { "ApplicationUserId" });
